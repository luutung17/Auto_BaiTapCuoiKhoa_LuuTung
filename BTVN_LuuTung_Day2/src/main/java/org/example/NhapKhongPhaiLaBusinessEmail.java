...
public class NhapKhongPhaiLaBusinessEmail {
    public static void main(String[] args) throws Exception {
        ...
        WebElement errorMessage = driver.findElement(
                By.xpath("//*[text()=\"Enter valid business email address\"]")
        );

        if(errorMessage.isDisplayed()){
            System.out.println("Test Passed - Not BusinessEmail ");
        }else{
